...
tools = [
    ("🤖", "АИ-помощник", "Чат-копилот: проекты, история, инструменты", "pages/01_🤖_АИ_Помощник.py"),
    ("📱", "Аккаунты", "Управление мульти-аккаунтами TikTok/IG/YT", "pages/1_📱_Аккаунты.py"),
    ("📊", "Аналитика", "Подписчики, лайки, рост по дням", "pages/1f_📊_Аналитика.py"),
